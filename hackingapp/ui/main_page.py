...
from hackingapp.ui.event_handler import (
    eventHelpButtonPressed, eventAttackButtonPressed, eventPauseButtonPressed
)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        help_action.triggered.connect(lambda: eventHelpButtonPressed(self))
        ...
        self.start_btn.clicked.connect(lambda: eventAttackButtonPressed(self))
        self.pause_btn = QPushButton("Pause")
        self.pause_btn.clicked.connect(lambda: eventPauseButtonPressed(self))
